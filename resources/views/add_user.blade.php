    ...
    <div class="mx-2">
      ...
      <form action="{{route('users.store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-5">
            <input name="first_name" type="text" placeholder="First Name" class="form-control py-2"  value="{{old('first_name')}}"  />
            @error('first_name')
            <div class="alert alert-warning">{{$message}}</div>
            @enderror
          </div>
          <div class="col-md-5">
            <input name="last_name" type="text" placeholder="Last Name" class="form-control py-2"  value="{{old('last_name')}}"/>
            @error('last_name')
            <div class="alert alert-warning">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          <label for="" class="form-label col-md-2 fw-bold text-md-end">User Name</label>
          <div class="col-md-10">
            <input name="user_name" type="text" placeholder="e.g. Jhon33" class="form-control py-2"  value="{{old('user_name')}}" />
            @error('user_name')
            <div class="alert alert-warning">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input name="email" type="email" placeholder="e.g. Jhon@example.com" class="form-control py-2"  value="{{old('email')}}" />
            @error('email')
            <div class="alert alert-warning">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input name="password" type="password" placeholder="Password" class="form-control py-2"  value="{{old('password')}}" />
            @error('password')
            <div class="alert alert-warning">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          ...
          <div class="col-md-10">
            <input name="password" type="password" placeholder="Confirm Password" class="form-control py-2"  value="{{old('password')}}" />
            @error('password')
            <div class="alert alert-warning">{{$message}}</div>
            @enderror
          </div>
        ...
        <div class="form-group mb-3 row">
          <label for="image" class="form-label col-md-2 fw-bold text-md-end">Profile Image</label>
          <div class="col-md-10">
              <input name="image" type="file" class="form-control py-2" />
              @error('image')
              <div class="alert alert-warning">{{$message}}</div>
              @enderror
          </div>
